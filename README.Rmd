...
[![Linting code](https://github.com/InseeFr/rjd3qr/actions/workflows/lint.yaml/badge.svg)](https://github.com/InseeFr/rjd3qr/actions/workflows/lint.yaml)
...
Pour cela, il faut modifier l'option `"JDCruncheR.thresholds"`.
...
You have to modify the option `"JDCruncheR.thresholds"`.
